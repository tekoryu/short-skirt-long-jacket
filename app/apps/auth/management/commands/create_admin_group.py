...
from apps.auth.models import (
    User, ResourcePermission, GroupResourcePermission
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create or get the administrator group using Django's built-in Group
        ...
        resources = [
            {
                ...
                'permissions': [
                    ...
                    {'type': 'change', 'name': 'Edit Cities', 'codename': 'edit_cities_city', 'description': 'Permission to edit cities data'},
                ]
            },
        ...
        for resource in resources:
            ...
            for perm_def in resource['permissions']:
                ...
                group_perm, gp_created = GroupResourcePermission.objects.get_or_create(
                    group=group,
        ...
        # Add all superusers to the group using Django's built-in many-to-many
